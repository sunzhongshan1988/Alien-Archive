...
use super::game_menu_codex::{
    ...
    draw_codex_discovery_card, draw_codex_entry_card, upload_codex_entry_cards,
};
...
use super::game_menu_inventory::{
    InventoryDetailText, draw_inventory_slot, equipment_module_slots, inventory_capacity,
    upload_inventory_slot_counts, upload_inventory_slot_details,
};
use super::game_menu_map::draw_map_page as draw_game_menu_map_page;
use super::game_menu_profile::{
    draw_attribute_icon, draw_compact_stat_bar, draw_equipment_status_row, draw_status_card,
    xp_ratio,
};
...
impl GameMenuScene {
    ...
    fn draw_map_page(&self, renderer: &mut dyn Renderer, viewport: Vec2, layout: &MenuLayout) {
        draw_game_menu_map_page(renderer, viewport, layout, &self.text.map_labels);
    }
